...
import (
	...
	modulev1 "gluon/api/gluon/contract/module"
	"gluon/x/contract/client/cli"
...
func (am AppModule) BeginBlock(ctx context.Context) error {
	err := am.keeper.GarbageCollect(ctx)
	if err != nil {
		return err
	}
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{ContractKeeper: k, Module: m}
}
