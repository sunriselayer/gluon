...
func (m *SortedLazyContract) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
var fileDescriptor_1f86f01373e97949 = []byte{
	...
	0xf1, 0x81, 0x95, 0xea, 0xc1, 0x44, 0x95, 0x9c, 0xb8, 0x84, 0x82, 0xc1, 0xaa, 0x7d, 0x12, 0xab,
	0x2a, 0x9d, 0xa1, 0xa2, 0x42, 0x62, 0x5c, 0x6c, 0xa9, 0x15, 0x05, 0x99, 0x45, 0x95, 0x12, 0x8c,
	0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x50, 0x9e, 0x90, 0x08, 0x17, 0x6b, 0x66, 0x5e, 0x4a, 0x6a, 0x85,
	0x04, 0x13, 0x58, 0x18, 0xc2, 0x71, 0x32, 0x38, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6,
	0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39,
	0x86, 0x28, 0x31, 0x88, 0xc3, 0x2a, 0x10, 0x4e, 0x2b, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03,
	0x3b, 0xc6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xe7, 0xfb, 0x4c, 0x28, 0xb9, 0x00, 0x00, 0x00,
}
...
func (m *SortedLazyContract) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Index != 0 {
		i = encodeVarintSortedLazyContract(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x10
	}
	if m.Expiry != 0 {
...
func (m *SortedLazyContract) Size() (n int) {
	...
	if m.Index != 0 {
		n += 1 + sovSortedLazyContract(uint64(m.Index))
	}
	return n
}
