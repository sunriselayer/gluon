...
var (
	...
	ErrLazyContractNotAllowed        = sdkerrors.Register(ModuleName, 1113, "lazy contract not allowed")
	ErrOrderExpireBeforeLazyContract = sdkerrors.Register(ModuleName, 1114, "order expire before lazy contract")
