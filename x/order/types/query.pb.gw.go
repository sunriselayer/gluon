...
var (
	filter_Query_Orders_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"gluon", "order", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"gluon", "order", "v1", "orders", "owner", "hash"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"gluon", "order", "v1", "orders", "owner"}, "", runtime.AssumeColonVerbOpt(false)))
)
