...
var (
	...
	ErrNotPositive                   = sdkerrors.Register(ModuleName, 1101, "value must be positive")
	ErrEmptyOrderHash                = sdkerrors.Register(ModuleName, 1102, "order hash must not be empty")
