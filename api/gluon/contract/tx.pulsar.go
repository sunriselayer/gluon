...
func (x *fastReflection_MsgMatchLazyOrder) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Amount != "" {
		value := protoreflect.ValueOfString(x.Amount)
		if !f(fd_MsgMatchLazyOrder_amount, value) {
			return
		}
	}
	if x.Price != "" {
		value := protoreflect.ValueOfString(x.Price)
		if !f(fd_MsgMatchLazyOrder_price, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgMatchLazyOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "gluon.contract.MsgMatchLazyOrder.price":
		panic(fmt.Errorf("field price of message gluon.contract.MsgMatchLazyOrder is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gluon.contract.MsgMatchLazyOrder"))
		}
...
func (x *MsgMatchLazyOrder) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *MsgMatchLazyOrder) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
