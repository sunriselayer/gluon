...
var (
	...
	fd_Pairing_owner      protoreflect.FieldDescriptor
	fd_Pairing_index      protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Pairing_owner = md_Pairing.Fields().ByName("owner")
	fd_Pairing_index = md_Pairing.Fields().ByName("index")
...
func (x *fastReflection_Pairing) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Owner != "" {
		...
		if !f(fd_Pairing_owner, value) {
			return
		}
	}
	if x.Index != "" {
		value := protoreflect.ValueOfString(x.Index)
		if !f(fd_Pairing_index, value) {
			return
		}
	}
	if x.PublicKey != nil {
...
func (x *fastReflection_Pairing) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "gluon.customauth.Pairing.owner":
		return x.Owner != ""
	case "gluon.customauth.Pairing.index":
		return x.Index != ""
...
func (x *fastReflection_Pairing) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "gluon.customauth.Pairing.owner":
		panic(fmt.Errorf("field owner of message gluon.customauth.Pairing is not mutable"))
	case "gluon.customauth.Pairing.index":
		panic(fmt.Errorf("field index of message gluon.customauth.Pairing is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gluon.customauth.Pairing"))
		}
...
func (x *Pairing) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *Pairing) GetIndex() string {
	if x != nil {
		return x.Index
	}
	return ""
...
var file_gluon_customauth_pairing_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0xcf, 0x01, 0x0a, 0x07, 0x50, 0x61, 0x69, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x2e, 0x0a, 0x05, 0x6f,
	...
	0x78, 0x12, 0x39, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18,
	...
	0x00, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x43, 0x0a, 0x0a,
	...
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x61, 0x75, 0x74, 0x68, 0x42, 0x0c, 0x50, 0x61, 0x69, 0x72,
	0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x1a, 0x67, 0x6c, 0x75, 0x6f,
