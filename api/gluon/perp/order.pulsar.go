...
var (
	...
	fd_PerpOrder_order           protoreflect.FieldDescriptor
...
func init() {
	...
	fd_PerpOrder_order = md_PerpOrder.Fields().ByName("order")
...
func (x *fastReflection_PerpOrder) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "gluon.perp.PerpOrder.order":
		return x.Order != nil
...
func (x *PerpOrder) GetOrder() *order.Order {
	if x != nil {
		return x.Order
	}
	return nil
...
var file_gluon_perp_order_proto_rawDesc = []byte{
	...
	0x09, 0x50, 0x65, 0x72, 0x70, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x05, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6c, 0x75, 0x6f,
	0x6e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x04, 0xc8,
	0xde, 0x1f, 0x00, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x73,
	...
	0xc8, 0xde, 0x1f, 0x00, 0x52, 0x06, 0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x3a, 0x0a, 0x82, 0xe7,
	0xb0, 0x2a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x7b, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_gluon_perp_order_proto_depIdxs = []int32{
	1, // 0: gluon.perp.PerpOrder.order:type_name -> gluon.order.Order
