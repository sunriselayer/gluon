...
const (
	Msg_UpdateParams_FullMethodName      = "/gluon.order.Msg/UpdateParams"
	Msg_LazyRegisterOrder_FullMethodName = "/gluon.order.Msg/LazyRegisterOrder"
	Msg_CancelOrder_FullMethodName       = "/gluon.order.Msg/CancelOrder"
)
