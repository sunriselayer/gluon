...
const (
	Query_Params_FullMethodName = "/gluon.order.Query/Params"
	Query_Order_FullMethodName  = "/gluon.order.Query/Order"
	Query_Orders_FullMethodName = "/gluon.order.Query/Orders"
)
