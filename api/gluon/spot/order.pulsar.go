...
var (
	...
	fd_SpotOrder_nonce protoreflect.FieldDescriptor
...
func init() {
	...
	fd_SpotOrder_nonce = md_SpotOrder.Fields().ByName("nonce")
...
func (x *SpotOrder) slowProtoReflect() protoreflect.Message {
	mi := &file_gluon_spot_order_proto_msgTypes[0]
...
func (x *fastReflection_SpotOrder) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "gluon.spot.SpotOrder.nonce":
	...
	default:
		...
		panic(fmt.Errorf("message gluon.spot.SpotOrder does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SpotOrder) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message gluon.spot.SpotOrder does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SpotOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "gluon.spot.SpotOrder.nonce":
		panic(fmt.Errorf("field nonce of message gluon.spot.SpotOrder is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: gluon.spot.SpotOrder"))
		}
...
func (x *fastReflection_SpotOrder) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in gluon.spot.SpotOrder", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *SpotOrder) GetNonce() uint64 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
var File_gluon_spot_order_proto protoreflect.FileDescriptor
...
var file_gluon_spot_order_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x57, 0x0a, 0x09, 0x53, 0x70, 0x6f, 0x74,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x34, 0x0a, 0x04, 0x62,
	0x61, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67, 0x6c, 0x75, 0x6f,
	...
	0x65, 0x42, 0x7b, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6c, 0x75, 0x6f, 0x6e, 0x2e, 0x73,
	0x70, 0x6f, 0x74, 0x42, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_gluon_spot_order_proto_rawDescOnce sync.Once
	file_gluon_spot_order_proto_rawDescData = file_gluon_spot_order_proto_rawDesc
)

func file_gluon_spot_order_proto_rawDescGZIP() []byte {
	file_gluon_spot_order_proto_rawDescOnce.Do(func() {
		file_gluon_spot_order_proto_rawDescData = protoimpl.X.CompressGZIP(file_gluon_spot_order_proto_rawDescData)
	})
	return file_gluon_spot_order_proto_rawDescData
}
...
func init() { file_gluon_spot_order_proto_init() }
func file_gluon_spot_order_proto_init() {
	if File_gluon_spot_order_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gluon_spot_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gluon_spot_order_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gluon_spot_order_proto_goTypes,
		DependencyIndexes: file_gluon_spot_order_proto_depIdxs,
		MessageInfos:      file_gluon_spot_order_proto_msgTypes,
	}.Build()
	File_gluon_spot_order_proto = out.File
	file_gluon_spot_order_proto_rawDesc = nil
	file_gluon_spot_order_proto_goTypes = nil
	file_gluon_spot_order_proto_depIdxs = nil
}
